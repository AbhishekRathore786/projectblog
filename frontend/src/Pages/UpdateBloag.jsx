...
const UpdateBloag = () => {
    ...
    const updateBlogHandler = async () => {
        ...
        try {
            ...
            const res = await axios.put(`https://projectblog-3.onrender.com/api/v1/blog/${id}`, formData, {
                headers: {
    ...
    const togglePublishUnPublished = async () => {
        try {
            ...
            const res = await axios.patch(`https://projectblog-3.onrender.com/api/v1/blog/${id}`,
                {
                    withCredentials: true
                })
            if (res.data.success) {
    ...
    const deleteBlog = async (id) => {
        try {
            const res = await axios.delete(`https://projectblog-3.onrender.com/api/v1/blog/delete/${id}`, {
                withCredentials: true
            })
            if (res.data.success) {
